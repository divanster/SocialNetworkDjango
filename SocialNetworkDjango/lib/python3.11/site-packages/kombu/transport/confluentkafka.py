"""confluent-kafka_app transport module for Kombu.

Kafka transport using confluent-kafka_app library.
...
The confluent-kafka_app transport does not support PyPy environment.
...
class Transport(virtual.Transport):
    ...
    def __init__(self, client, **kwargs):
        if confluent_kafka is None:
            raise ImportError('The confluent-kafka_app library is not installed')
