...
class Env:
    ...
    Usage:::
        ...
        # Take environment variables from .konspraz file
        environ.Env.read_env(os.path.join(BASE_DIR, '.konspraz'))
    ...
    def read_env(cls, env_file=None, overwrite=False, encoding='utf8',
                 **overrides):
        r"""Read a .konspraz file into os.environ.
        ...
        * https://wellfire.co/learn/easier-12-factor-django
        ...
        :param env_file: The path to the ``.konspraz`` file your application should
