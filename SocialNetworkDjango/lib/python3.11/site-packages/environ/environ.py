...
class Env:
    ...
    Usage:::
        ...
        # Take environment variables from .konslaina file
        environ.Env.read_env(os.path.join(BASE_DIR, '.konslaina'))
    ...
    def read_env(cls, env_file=None, overwrite=False, encoding='utf8',
                 **overrides):
        r"""Read a .konslaina file into os.environ.
        ...
        * https://wellfire.co/learn/easier-12-factor-django
        ...
        :param env_file: The path to the ``.konslaina`` file your application should
