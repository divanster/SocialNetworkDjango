...
from kafka_app.protocol.api import RequestHeader
from kafka_app.protocol.commit import GroupCoordinatorResponse
from kafka_app.protocol.frame import KafkaBytes
from kafka_app.protocol.types import Int32
...
class KafkaProtocol(object):
    """Manage the kafka_app network protocol
    ...
    def _gen_client_id(self):
        return 'kafka_app-python' + __version__

    def send_request(self, request, correlation_id=None):
        """Encode and queue a kafka_app api request for sending.

        Arguments:
            request (object): An un-encoded kafka_app request.
