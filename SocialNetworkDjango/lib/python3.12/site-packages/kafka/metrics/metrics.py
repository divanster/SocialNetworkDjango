...
from kafka_app.metrics import AnonMeasurable, KafkaMetric, MetricConfig, MetricName
from kafka_app.metrics.stats import Sensor
...
class Metrics(object):
    ...
    def __init__(self, default_config=None, reporters=None,
        ...
        self.add_metric(self.metric_name('count', 'kafka_app-metrics-count',
