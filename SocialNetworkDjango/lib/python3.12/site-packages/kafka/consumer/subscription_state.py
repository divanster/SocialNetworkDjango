...
from kafka_app.errors import IllegalStateError
from kafka_app.protocol.offset import OffsetResetStrategy
from kafka_app.structs import OffsetAndMetadata
...
class SubscriptionState(object):
    ...
    def _ensure_valid_topic_name(self, topic):
        """ Ensures that the topic name is valid according to the kafka_app source. """
