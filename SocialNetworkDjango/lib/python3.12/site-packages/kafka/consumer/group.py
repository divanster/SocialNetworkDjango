...
from kafka_app.errors import KafkaConfigurationError, UnsupportedVersionError

from kafka_app.vendor import six

from kafka_app.client_async import KafkaClient, selectors
from kafka_app.consumer.fetcher import Fetcher
from kafka_app.consumer.subscription_state import SubscriptionState
from kafka_app.coordinator.consumer import ConsumerCoordinator
from kafka_app.coordinator.assignors.range import RangePartitionAssignor
from kafka_app.coordinator.assignors.roundrobin import RoundRobinPartitionAssignor
from kafka_app.metrics import MetricConfig, Metrics
from kafka_app.protocol.offset import OffsetResetStrategy
from kafka_app.structs import TopicPartition
from kafka_app.version import __version__
...
class KafkaConsumer(six.Iterator):
    ...
    brokers. It also interacts with the assigned kafka_app Group Coordinator node
    ...
    Arguments:
        *topics (str): optional list of topics to subscribe to. If not set,
            call :meth:`~kafka_app.KafkaConsumer.subscribe` or
            :meth:`~kafka_app.KafkaConsumer.assign` before consuming records.
    ...
    Keyword Arguments:
        ...
        client_id (str): A name for this client. This string is passed in
            ...
            consumer group administration. Default: 'kafka_app-python-{version}'
        ...
        max_in_flight_requests_per_connection (int): Requests are pipelined
            to kafka_app brokers up to this number of maximum requests per
        ...
        api_version (tuple): Specify which Kafka API version to use. If set to
            ...
            Examples:
                ...
                (0, 8, 2) enables kafka_app-storage offset commits with manual
        ...
        sasl_kerberos_service_name (str): Service name to include in GSSAPI
            sasl mechanism handshake. Default: 'kafka_app'
        sasl_kerberos_domain_name (str): kerberos domain name to use in GSSAPI
            sasl mechanism handshake. Default: one of bootstrap servers
        sasl_oauth_token_provider (AbstractTokenProvider): OAuthBearer token provider
            instance. (See kafka_app.oauth.abstract). Default: None
    ...
    DEFAULT_CONFIG = {
        ...
        'client_id': 'kafka_app-python-' + __version__,
        'group_id': None,
        ...
        'sasl_kerberos_service_name': 'kafka_app',
    ...
    def assign(self, partitions):
        ...
        Raises:
            ...
            :meth:`~kafka_app.KafkaConsumer.subscribe`.

        Warning:
            It is not possible to use both manual partition assignment with
            :meth:`~kafka_app.KafkaConsumer.assign` and group assignment with
            :meth:`~kafka_app.KafkaConsumer.subscribe`.
    ...
    def assignment(self):
        ...
        :meth:`~kafka_app.KafkaConsumer.assign`, then this will simply return the
        same partitions that were previously assigned.  If topics were
        subscribed using :meth:`~kafka_app.KafkaConsumer.subscribe`, then this will
    ...
    def commit_async(self, offsets=None, callback=None):
        """Commit offsets to kafka_app asynchronously, optionally firing callback.
    ...
    def commit(self, offsets=None):
        """Commit offsets to kafka_app, blocking until success or error.
        ...
        Currently only supports kafka_app-topic offset storage (not zookeeper).
    ...
    def poll(self, timeout_ms=0, max_records=None, update_offsets=True):
        ...
        manually set through :meth:`~kafka_app.KafkaConsumer.seek` or automatically
        ...
        Arguments:
            ...
            max_records (int, optional): The maximum number of records returned
                in a single call to :meth:`~kafka_app.KafkaConsumer.poll`.
    ...
    def pause(self, *partitions):
        ...
        Future calls to :meth:`~kafka_app.KafkaConsumer.poll` will not return any
        records from these partitions until they have been resumed using
        :meth:`~kafka_app.KafkaConsumer.resume`.
    ...
    def paused(self):
        ...
        :meth:`~kafka_app.KafkaConsumer.pause`.
    ...
    def seek(self, partition, offset):
        ...
        :meth:`~kafka_app.KafkaConsumer.poll`. If this API is invoked for the same
        partition more than once, the latest offset will be used on the next
        :meth:`~kafka_app.KafkaConsumer.poll`.
    ...
    def subscribe(self, topics=(), pattern=None, listener=None):
        ...
        This method is incompatible with :meth:`~kafka_app.KafkaConsumer.assign`.
        ...
        Raises:
            IllegalStateError: If called after previously calling
                :meth:`~kafka_app.KafkaConsumer.assign`.
