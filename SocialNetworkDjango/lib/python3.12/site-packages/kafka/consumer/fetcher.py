...
from kafka_app.protocol.offset import (
    OffsetRequest, OffsetResetStrategy, UNKNOWN_OFFSET
)
from kafka_app.record import MemoryRecords
from kafka_app.serializer import Deserializer
from kafka_app.structs import TopicPartition, OffsetAndTimestamp
