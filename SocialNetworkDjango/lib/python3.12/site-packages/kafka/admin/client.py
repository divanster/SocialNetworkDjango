...
from kafka_app.admin.acl_resource import ACLOperation, ACLPermissionType, ACLFilter, ACL, ResourcePattern, ResourceType, \
    ACLResourcePatternType
from kafka_app.client_async import KafkaClient, selectors
from kafka_app.coordinator.protocol import ConsumerProtocolMemberMetadata, ConsumerProtocolMemberAssignment, ConsumerProtocol
import kafka_app.errors as Errors
from kafka_app.errors import (
...
from kafka_app.protocol.admin import (
    CreateTopicsRequest, DeleteTopicsRequest, DescribeConfigsRequest, AlterConfigsRequest, CreatePartitionsRequest,
    ListGroupsRequest, DescribeGroupsRequest, DescribeAclsRequest, CreateAclsRequest, DeleteAclsRequest,
    DeleteGroupsRequest
)
from kafka_app.protocol.commit import GroupCoordinatorRequest, OffsetFetchRequest
from kafka_app.protocol.metadata import MetadataRequest
from kafka_app.protocol.types import Array
from kafka_app.structs import TopicPartition, OffsetAndMetadata, MemberInformation, GroupInformation
...
class KafkaAdminClient(object):
    ...
    protocol format supported by both the kafka_app-python client library and the
    ...
    def _matching_api_version(self, operation):
        ...
        :param operation: A list of protocol operation versions from kafka_app.protocol.
