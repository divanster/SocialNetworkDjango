...
from kafka_app.metrics.measurable import AnonMeasurable
from kafka_app.metrics.stats import Avg, Max, Rate
    ...
    def run(self):
        ...
        while self._running:
            try:
                ...
                log.exception("Uncaught error in kafka_app producer I/O thread")
