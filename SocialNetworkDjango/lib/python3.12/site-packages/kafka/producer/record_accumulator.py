...
from kafka_app.producer.buffer import SimpleBufferPool
from kafka_app.producer.future import FutureRecordMetadata, FutureProduceResult
from kafka_app.record.memory_records import MemoryRecordsBuilder
...
class RecordAccumulator(object):
    ...
    def abort_expired_batches(self, request_timeout_ms, cluster):
        ...
        Arguments:
            ...
            cluster (ClusterMetadata): current metadata for kafka_app cluster
