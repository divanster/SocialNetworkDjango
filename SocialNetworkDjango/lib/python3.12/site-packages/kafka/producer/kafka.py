...
from kafka_app.codec import has_gzip, has_snappy, has_lz4, has_zstd
from kafka_app.metrics import MetricConfig, Metrics
from kafka_app.partitioner.default import DefaultPartitioner
from kafka_app.producer.future import FutureRecordMetadata, FutureProduceResult
from kafka_app.producer.record_accumulator import AtomicInteger, RecordAccumulator
from kafka_app.producer.sender import Sender
from kafka_app.record.default_records import DefaultRecordBatchBuilder
from kafka_app.record.legacy_records import LegacyRecordBatchBuilder
from kafka_app.serializer import Serializer
...
class KafkaProducer(object):
    ...
    :meth:`~kafka_app.KafkaProducer.send` is asynchronous. When called it adds the
    ...
    Keyword Arguments:
        ...
        client_id (str): a name for this client. This string is passed in
            ...
            Default: 'kafka_app-python-producer-#' (appended with a unique number
            per instance)
        ...
        max_block_ms (int): Number of milliseconds to block during
            :meth:`~kafka_app.KafkaProducer.send` and
            :meth:`~kafka_app.KafkaProducer.partitions_for`. These methods can be
    ...
    def __init__(self, **configs):
        ...
        if self.config['client_id'] is None:
            self.config['client_id'] = 'kafka_app-python-producer-%s' % \
    ...
    def send(self, topic, value=None, key=None, headers=None, partition=None, timestamp_ms=None):
        ...
        Arguments:
            ...
            value (optional): message value. Must be type bytes, or be
                ...
                See kafka_app compaction documentation for more details:
                https://kafka.apache.org/documentation.html#compaction
                (compaction requires kafka_app >= 0.8.1)
        ...
        assert value is not None or self.config['api_version'] >= (0, 8, 1), (
            'Null messages require kafka_app >= 0.8.1')
    ...
    def flush(self, timeout=None):
        ...
        post-condition of :meth:`~kafka_app.KafkaProducer.flush` is that any
