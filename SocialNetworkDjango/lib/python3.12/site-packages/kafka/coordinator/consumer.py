...
from kafka_app.coordinator.base import BaseCoordinator, Generation
...
from kafka_app.coordinator.assignors.sticky.sticky_assignor import StickyPartitionAssignor
from kafka_app.coordinator.protocol import ConsumerProtocol
...
from kafka_app.protocol.commit import OffsetCommitRequest, OffsetFetchRequest
from kafka_app.structs import OffsetAndMetadata, TopicPartition
from kafka_app.util import WeakMethod
...
class ConsumerCoordinator(BaseCoordinator):
    ...
    DEFAULT_CONFIG = {
        'group_id': 'kafka_app-python-default-group',
    ...
    def __init__(self, client, subscription, metrics, **configs):
        ...
        Keyword Arguments:
            group_id (str): name of the consumer group to join for dynamic
                ...
                committing offsets. Default: 'kafka_app-python-default-group'
    ...
    def _handle_offset_commit_response(self, offsets, future, send_time, response):
        # TODO look at adding request_latency_ms to response (like java kafka_app)
