...
from kafka_app.cluster import ClusterMetadata
from kafka_app.conn import BrokerConnection, ConnectionStates, collect_hosts, get_ip_port_afi
from kafka_app import errors as Errors
from kafka_app.future import Future
from kafka_app.metrics import AnonMeasurable
from kafka_app.metrics.stats import Avg, Count, Rate
from kafka_app.metrics.stats.rate import TimeUnit
from kafka_app.protocol.metadata import MetadataRequest
from kafka_app.util import Dict, WeakMethod
# Although this looks unused, it actually monkey-patches socket.socketpair()
# and should be left in as long as we're using socket.socketpair() in this file
from kafka_app.vendor import socketpair
...
log = logging.getLogger('kafka_app.client')
...
class KafkaClient(object):
    ...
    Attributes:
        cluster (:any:`ClusterMetadata`): Local cache of cluster metadata, retrieved
            via MetadataRequests during :meth:`~kafka_app.KafkaClient.poll`.
    ...
    def get_api_versions(self):
        ...
        or None if ApiVersion is not supported by the kafka_app cluster.
        """
