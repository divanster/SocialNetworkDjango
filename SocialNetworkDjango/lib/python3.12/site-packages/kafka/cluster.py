...
from kafka_app.conn import collect_hosts
from kafka_app.future import Future
from kafka_app.structs import BrokerMetadata, PartitionMetadata, TopicPartition
...
class ClusterMetadata(object):
    """
    A class to manage kafka_app cluster metadata.
    ...
    def request_update(self):
        ...
        Returns:
            kafka_app.future.Future (value will be the cluster object after update)
        """
        with self._lock:
            self._need_update = True
