...
class Notification(Document):
    ...
    """
    # Define notification types inside the model class
    NOTIFICATION_TYPES = (
        ('like', 'Like'),
        ('comment', 'Comment'),
        ('follow', 'Follow'),
    ...
    notification_type = StringField(max_length=21, choices=NOTIFICATION_TYPES, default='like', help_text="Type of notification")
    ...
    def get_notification_type_display(self):
        ...
        """
        return dict(self.NOTIFICATION_TYPES).get(self.notification_type, "Unknown")
