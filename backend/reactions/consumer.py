...
class KafkaReactionConsumer:
    ...
    def consume_messages(self):
        for message in self.consumer:
            try:
                data = message.value
                # Add your reaction-specific processing logic here
                logger.info(f"Processed reaction event: {data}")
            except Exception as e:
...
if __name__ == "__main__":
    ...
    reaction_consumer = KafkaReactionConsumer(topic)
    reaction_consumer.consume_messages()
