...
const Profile: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfileData = async () => {
            try {
                const response = await axios.get('/api/users/profile/'); // Replace with actual API endpoint
    ...
    return (
        <div className="profile">
            <img src={profileData.profile_picture || '/path/to/default-pic.jpg'} alt="Profile" className="img-fluid rounded-circle" />
